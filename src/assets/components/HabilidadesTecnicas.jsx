...
const habilidades = [
  ...
  { nombre: 'R', nivel: 40, detalle: 'Análisis estadístico, visualización de datos, ggplot2.' },
  { nombre: 'PostgreSQL', nivel: 60, detalle: 'Joins, vistas, funciones, relaciones y normalización.' },
  { nombre: 'SQL', nivel: 78, detalle: 'Consultas, agrupaciones, subconsultas, optimización de bases relacionales.' },
  { nombre: 'React', nivel: 50, detalle: 'Crear interfaces de usuario dinámicas.' }
];
